import { UserRound, Heart, Search, AlignJustify } from 'lucide-react';
...
export default function Navbar() {
  return (
    ...
    <nav className='sections flex justify-between max-w-[500px] sm:max-w-full md:hidden' >
      ...
      <AlignJustify color="#484848" size={24} strokeWidth={1.5} className='' />
      ...
      <NavLink to="/REACT-DUMMY/checkout"> 
