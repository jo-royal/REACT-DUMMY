  ...
  return (
    ...
    <nav className='sections flex justify-between max-w-[500px] sm:max-w-full md:hidden' >
      ...
      <NavLink to="/REACT-DUMMY/cart"> 
        ...
        <NavLink to="/REACT-DUMMY/wishlist"> <Star color="#484848" size={24} stroke-width={1.5}/> </NavLink>
        <NavLink to="/REACT-DUMMY/login">  <UserRound color="#484848" size={24} stroke-width={1.5}/> </NavLink>
      </div>
